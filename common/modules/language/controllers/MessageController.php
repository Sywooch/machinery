...
use common\modules\language\models\MessageSearch;
...
class MessageController extends Controller
{
     ...
     * @return mixed
     */
    public function actionUpdate($id, $language, $ajax = null)
    {
        $model = $this->findModel($id, $language, $ajax);
     ...
     */
    protected function findModel($id, $language, $create = null)
    {
