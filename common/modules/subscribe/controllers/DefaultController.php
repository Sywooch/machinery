...
namespace common\modules\subscribe\controllers;
...
/**
 * DefaultController implements the CRUD actions for Subscribe model.
 */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            if(Yii::$app->request->isAjax){
                return Json::encode(['status' => 'ok', 'message'=>Yii::t('app', 'You have successfully subscribed!')]);
            }
