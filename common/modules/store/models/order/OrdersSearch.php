...
class OrdersSearch extends Orders
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'ordered' => is_null($this->ordered) ? 1 : $this->ordered,
            'status' => is_null($this->status) ? null : (array_search($this->status, $this->statuses) ? array_search($this->status, $this->statuses) : null),
        ]);
