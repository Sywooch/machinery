...
<div class="widget-menu-block">
    ...
    echo Html::a('<span class="menu-item"><span class="glyphicon glyphicon-shopping-cart pull-left"></span>Заказы<span class="badge">' . StatusRepository::countStatus([1], Orders::class) . '</span></span>', ['/orders/default'], ['class' => $widget->isActive(['orders'])]);
