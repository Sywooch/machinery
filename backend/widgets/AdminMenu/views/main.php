...
<div class="widget-menu-block">
    ...
    echo Html::a('<span class="menu-item"><span class="glyphicon glyphicon-align-center  pull-left"></span>Группы характеристик</span>', ['/group-characteristics'], ['class' => $widget->isActive(['group-characteristics'])]);
