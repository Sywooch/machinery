...
<div class="widget-menu-block">
    ...
    echo Html::a('<span class="menu-item"><span class="glyphicon glyphicon-cog  pull-left"></span>Настройка продукта</span>', ['/product/group-characteristics'], ['class' => $widget->isActive(['product'])]);
