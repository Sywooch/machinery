...
<div class="widget-sub-menu-block">
    <?php
        ...
        if($widget->isActive(['promo-codes','default'])){
            
            echo Html::a('<div>Заказы</div>', ['/orders/default'], ['class' => $widget->isActive(['default'])]);
            echo Html::a('<div>Промокоды</div>', ['/orders/promo-codes'], ['class' => $widget->isActive(['promo-codes'])]);
        }
    ?>
</div>