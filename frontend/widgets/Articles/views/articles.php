<?php for($i=0; $i<3; $i++): ?>
    <div class="col-md-4"><article class="news-item">
            <div class="news-item-ttl h3 text-uppercase"><a href="#">Заголовок статьи которая здесь показывается на 2 строки максимум</a></div>
...
<?php endfor; ?>
<div class="col-md-12 text-center _more-link">
    <a href="#" class="btn btn-lg btn-default">All articles <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
</div>