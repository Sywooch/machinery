...
use frontend\widgets\Filter\Asset;
        ...
        <div class="form-group field-filterform-category">
            ...
            <?= Html::activeDropDownList(
                ...
                [
                    'id' => 'obj-manufacturer',
                    'name' => 'manufacturer',
                    'class' => 'filter-item form-control select-manufacturer',
                    'data-type' => 'DropDownListFilter',
...
<div class="row filter-form-row">
    ...
    <div class="col-md-4">
        ...
        <?php // $form->field($model, 'year')->dropDownList($years, ['prompt' => 'All']) ?>
    </div>
</div>
<div class="row filter-form-row">
    <div class="col-md-4">
        <div class="form-group field-filterform-country">
            ...
            <?= Html::activeDropDownList(
                ...
                [
                    'id' => 'obj-country',
                    'name' => 'country',
                    'class' => 'filter-item form-control select-country',
                    'data-type' => 'DropDownListFilter',
                    'prompt' => Yii::t('app', 'All'),
                ]); ?>
        </div>
