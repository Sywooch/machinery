    ...
    <div class="row row1">
        <div class="col-sm-12 col-md-10 col-lg-10 columns">
            ...
            <h4 style="text-align:left;">
                To complete your secure online order, please enter your billing information below.<br>The billing information should be exactly as it appears on your credit card statement.
            </h4>
        </div>
        <div style="margin-top:20px;" class="col-sm-12 col-md-2 col-lg-2 columns">
            <span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=wIdlekCEQ5gXSOh2BJxcVvcUfxqLlW0wYVXwDfCHd5lO2wBRh4N3Mxjh5E3n"></script></span>
        </div>
